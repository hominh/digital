<?php
    class Catalogproductvarchar extends MY_Controller {
        ...
        function index() {
            if(login()) {
                ...
                $this->data['list'] = $list;
                $this->load->view('admin/catalogproductvarchar/index',$this->data);
            }
            else {
        ...
        function create() {
            ...
            if($this->input->post()) {
                ...
                if($this->form_validation->run() == TRUE) {
                    ...
                    if($this->catalogproductvarchar_model->create($data)) {
                        $this->session->set_flashdata('message','Insert data successfully');
                    }
                    else {
						$this->session->set_flashdata('message','Insert data unsuccessful');
                    }
                    redirect(base_url()."admin/catalogproductvarchar");
                }
            }
            $this->load->view('admin/catalogproductvarchar/create',$this->data);
        }
