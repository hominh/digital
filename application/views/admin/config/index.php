						...
						<div class="card-header">
							...
							<div class="col-sm-3">
								<div class="float-right">
									<a href="<?php echo base_url()."admin/config/create"; ?>" class="btn btn-info" role="button">Create</a>
								</div>
									...
									<tbody>
										<?php foreach($list as $row): ?>
											<tr>
												...
												<td>
													<a href="<?php echo base_url()."admin/config/update/".$row->id; ?>"><button type="button" class="btn btn-success btn-sm">Edit</button></a>
													<a href="<?php echo base_url()."admin/config/delete/".$row->id; ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
