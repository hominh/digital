							...
							<div class="card-body card-block">
								<form enctype="multipart/form-data" method="post" action="" id="form" class="form-horizontal">
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9"><input type="text" id="price" name="price" placeholder="Enter price..." class="form-control"><span class="help-block"><?php echo form_error('price'); ?></span></div>
									</div>

									<div class="row form-group">
										<div class="col col-md-3"><label for="discount" class=" form-control-label">Discount</label></div>
										<div class="col-12 col-md-9"><input type="text" id="discount" name="discount" placeholder="Enter discount..." class="form-control"><span class="help-block"><?php echo form_error('discount'); ?></span></div>
									</div>
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9"><input type="text" id="warranty" name="warranty" placeholder="Enter warranty..." class="form-control"><span class="help-block"><?php echo form_error('warranty'); ?></span></div>
									</div>
									
									<div class="row form-group">
										<div class="col col-md-3"><label for="keyword" class=" form-control-label">Gifts</label></div>
										<div class="col-12 col-md-9"><input type="text" id="gifts" name="gifts" placeholder="Enter gifts..." class="form-control"><span class="help-block"><?php echo form_error('gifts'); ?></span></div>
									</div>
						...
						<div class="card">
							...
							<div class="card-body card-block">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<textarea name="content" rows="9" placeholder="Content..." class="form-control"></textarea>
									</div>
								</div>	
							</div>
                        </div>
