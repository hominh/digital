						...
						<div class="card-header">
							...
							<div class="col-sm-3">
								<div class="float-right">
									<a href="<?php echo base_url()."admin/blog/create"; ?>" class="btn btn-info" role="button">Create</a>
								</div>
									...
									<tbody>
										<?php foreach($list as $row): ?>
											<tr>
												...
												<td><image src="<?php echo base_url('upload/blogs/'.$row->image); ?>" style="max-width: 50%;height: auto;"></td>
												<td>
													<a href="<?php echo base_url()."admin/blog/update/".$row->id; ?>"><button type="button" class="btn btn-success btn-sm">Edit</button></a>
													<a href="<?php echo base_url()."admin/blog/delete/".$row->id; ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
