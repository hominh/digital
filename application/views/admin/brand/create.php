							...
							<div class="card-body card-block">
								<form enctype="multipart/form-data" method="post" action="" id="form" class="form-horizontal">
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9"><input type="text" id="title" name="title" placeholder="Enter title..." class="form-control"><span class="help-block"><?php echo form_error('title1'); ?></span></div>
									</div>
									<div class="row form-group">
