						...
						<div class="card-header">
							...
							<div class="col-sm-3">
								<div class="float-right">
									<a href="<?php echo base_url()."admin/brand/create"; ?>" class="btn btn-info" role="button">Create</a>
								</div>
									...
									<tbody>
										<?php foreach($list as $row): ?>
											<tr>
												...
												<td><image src="<?php echo base_url('upload/brands/'.$row->image); ?>"</td>
												<td><?php echo $row->link; ?></td>

												<td>
													<a href="<?php echo base_url()."admin/brand/update/".$row->id; ?>"><button type="button" class="btn btn-success btn-sm">Edit</button></a>
													<a href="<?php echo base_url()."admin/brand/delete/".$row->id; ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
