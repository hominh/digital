				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-header">
							<div class="col-sm-9">
								<strong class="card-title">Catalog</strong>
							</div>
							<div class="col-sm-3">
								<div class="float-right">
									<a href="<?php echo base_url()."admin/catalog/create"; ?>" class="btn btn-info" role="button">Create</a>
								</div>
									...
									<tbody>
										<?php foreach($list as $row): ?>
											<tr>
												...
												<td>
													<a href="<?php echo base_url()."admin/catalog/update/".$row->id; ?>"><button type="button" class="btn btn-success btn-sm">Edit</button></a>
													<a href="<?php echo base_url()."admin/catalog/delete/".$row->id; ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
