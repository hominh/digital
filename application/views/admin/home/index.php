									...
									<tbody>
										<?php foreach($list as $row): ?>
											<tr>
												...
												<td>
													<a href="<?php echo base_url()."admin/admin/edit/".$row->id; ?>"><button type="button" class="btn btn-success btn-sm">Edit</button></a>
													<a href="<?php echo base_url()."admin/admin/delete/".$row->id; ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
