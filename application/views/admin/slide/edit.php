							...
							<div class="card-body card-block">
								<form enctype="multipart/form-data" method="post" action="" id="form" class="form-horizontal">
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9"><input type="text" id="title1" name="title1" value="<?php echo $info->title1 ?>" placeholder="Enter title1..." class="form-control"><span class="help-block"><?php echo form_error('title1'); ?></span></div>
									</div>
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9">
											<img src="<?php echo base_url('upload/slides/'.$info->image)?>" style="width:100px;height:70px">
										</div>
									</div>

									<div class="row form-group">
										<div class="col col-md-3"><label for="title2" class=" form-control-label">Title2</label></div>
										<div class="col-12 col-md-9"><input type="text" id="title2" name="title2" value="<?php echo $info->title2 ?>" placeholder="Enter title2..." class="form-control"><span class="help-block"><?php echo form_error('title2'); ?></span></div>
									</div>

									<div class="row form-group">
										<div class="col col-md-3"><label for="title3" class=" form-control-label">Title3</label></div>
										<div class="col-12 col-md-9"><input type="text" id="title3" name="title3" value="<?php echo $info->title3 ?>" placeholder="Enter title3..." class="form-control"><span class="help-block"><?php echo form_error('title2'); ?></span></div>
									</div>
