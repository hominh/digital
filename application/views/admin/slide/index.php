				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-header">
							<strong class="card-title">Slide</strong>
						</div>
									...
									<tbody>
										<?php foreach($list as $row): ?>
											<tr>
												...
												<td><image src="<?php echo base_url('upload/slides/'.$row->image); ?>"</td>
												<td><?php echo $row->link; ?></td>
												<td><?php echo $row->title1; ?></td>
												<td><?php echo $row->title2; ?></td>
												<td>
													<a href="<?php echo base_url()."admin/slide/update/".$row->id; ?>"><button type="button" class="btn btn-success btn-sm">Edit</button></a>
													<a href="<?php echo base_url()."admin/slide/delete/".$row->id; ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
